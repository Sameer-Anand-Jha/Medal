...
def label_tag(img_label):
    ...
    ref={'Immune Cells':0, 'Stroma':1, 'Tumor':2, 'Necrosis':3, } #'Benign':0, 'Debris':3, 'Inflammatory':4, 'Muscle':5
    return ref[img_label]

class FhistDataset:
    #Load the Dataset
    def __init__(self,transforms=transforms.ToTensor(),path='D:\Academics\Sem_2\EE_691_RnD_Project\Git\data_target_test.csv'):
...
train_dataset = FhistDataset(path=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\data_target_test.csv', transforms=transform)
