...
def get_neg_patch(df, curr_neg_classes, transforms):
    ...
    img_location=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\96171d81-6aab-4a58-bdf4-2de8fa3e48f3\WSI\TCGA-44-2665-11A-01-TS1.e284642f-9ea2-473f-b1ef-40c35957c436.svs'
    ...
    W_target = np.array([
    [0.11952107, 0.58167602, -0.08860755],
...
class patchdataset:
    #Load the Dataset
    def __init__(self,transforms=transforms.ToTensor(),path=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\data_target_test.csv'):
...
class patchdataset_test:
    ...
    def __getitem__(self, idx):
        ...
        img_name_csv=random_csv_path.split('/')[-1]
        img_name = "96171d81-6aab-4a58-bdf4-2de8fa3e48f3"
        img_location=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\96171d81-6aab-4a58-bdf4-2de8fa3e48f3\WSI'
        # print(img_name)
        img_path=os.path.join(img_location,img_name)
