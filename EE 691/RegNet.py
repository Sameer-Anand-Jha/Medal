...
out='./model_wt/RegNet_new/13sept_cn_cj'
if not os.path.exists(out):
    os.makedirs(out)

PATH = os.path.join(out,'regnet.pth')
...
random_color_jitter = transforms.RandomApply([color_jitter], p=0.40)
...
train_dataset = patchdataset(path=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\Tumor-Classification-HNSC-main\data_256_train_fltr.csv',transforms=torch_transform)
val_dataset = patchdataset_test(path=r'D:\Academics\Sem_2\EE_691_RnD_Project\Git\Tumor-Classification-HNSC-main\data_256_test_fltr.csv' ,transforms=torch_transform1)
...
# model_path='/workspace/hnsc_for_tumor/tum_ntum/tum_ntum1/model_wt/Efficientnet/18_wc_0.3cj_june/Resnet34_best_val_0.8043_iteration_2_50.pth'
        ...
        if i % 5 == 0:
            ...
            with torch.no_grad():
                ...
                if val_acc > best_val_acc:
                    ...
                    best_model_path = os.path.join(out, f'RegNet_best_val_{best_val_acc:.4f}_iteration_{epoch+1}_{i}.pth')
